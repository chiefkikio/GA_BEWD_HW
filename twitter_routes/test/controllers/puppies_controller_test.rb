...
class PuppiesControllerTest < ActionController::TestCase
  ...
  test "should create puppy" do
    assert_difference('Puppy.count') do
      post :create, puppy: { age: @puppy.age, breed: @puppy.breed, name: @puppy.name, num_legs: @puppy.num_legs, size: @puppy.size }
    end
  ...
  test "should update puppy" do
    patch :update, id: @puppy, puppy: { age: @puppy.age, breed: @puppy.breed, name: @puppy.name, num_legs: @puppy.num_legs, size: @puppy.size }
    assert_redirected_to puppy_path(assigns(:puppy))
  end
